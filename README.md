...
- Attempted to build a brushless ESC (electronic speed controller) from scratch using an arduino and a custom PCB, but was unsuccessful due to the unavailability of some components and limited PCB making ability.
